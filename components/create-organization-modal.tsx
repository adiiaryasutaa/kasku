    ...
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="sm:max-w-[550px]">
        <DialogHeader>
          ...
          <DialogDescription>Set up a new organization to track finances and manage budgets.</DialogDescription>
        </DialogHeader>
        ...
        <form onSubmit={handleSubmit} className="space-y-6 py-4">
          <div className="space-y-4">
            ...
            <div className="flex flex-col items-center justify-center gap-2">
              <div className="w-24 h-24 rounded-full bg-zinc-100 dark:bg-zinc-800 flex items-center justify-center overflow-hidden border border-zinc-200 dark:border-zinc-700">
                {logoPreview ? (
                  ...
                  <PopoverTrigger asChild>
                    <Button
                      ...
                      className={cn(
                        ...
                        !formData.fiscalYearStart && "text-muted-foreground",
                      )}
                    >
                      <CalendarIcon className="mr-2 h-4 w-4" />
                      {formData.fiscalYearStart ? format(formData.fiscalYearStart, "PPP") : <span>Pick a date</span>}
                    </Button>
                  </PopoverTrigger>
                  <PopoverContent className="w-auto p-0">
                    <Calendar
                      mode="single"
                      selected={formData.fiscalYearStart}
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <Input
                  ...
                  onChange={handleInputChange}
                  placeholder="0.00"
                  className={cn("pl-8", errors.initialBalance ? "border-red-500" : "")}
                />
              </div>
              {errors.initialBalance && <p className="text-xs text-red-500">{errors.initialBalance}</p>}
