  ...
  if (requests.length === 0) {
    return (
      <div className="p-6 text-center">
        ...
        <h3 className="text-lg font-medium text-zinc-900 dark:text-zinc-100">No pending approvals</h3>
        <p className="text-sm text-zinc-600 dark:text-zinc-400 mt-1">All transactions have been reviewed.</p>
      </div>
    )
  }
          ...
          >
            <div className="flex items-start justify-between mb-3">
              <div className="flex items-center gap-2">
                ...
                />
                <div>
                  <h3 className="text-sm font-medium text-zinc-900 dark:text-zinc-100">{request.title}</h3>
                  <p className="text-xs text-zinc-600 dark:text-zinc-400">
                    By {request.requester.name} • {request.category}
                  </p>
                </div>
              </div>
              <span className="text-sm font-medium text-red-600 dark:text-red-400">{request.amount}</span>
            </div>

            <div className="flex items-center gap-2 mb-3">
              <Clock className="w-3.5 h-3.5 text-zinc-500 dark:text-zinc-400" />
              <span className="text-xs text-zinc-600 dark:text-zinc-400">{request.timestamp}</span>
